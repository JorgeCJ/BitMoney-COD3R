...
export default function SumarioItemProps(props: SumarioItemProps) {
  return (
    <div className={`
relative flex flex-col bg-black pt-4 pb-3 px-5 rounded-lg border border-zinc-800 text-white
`}>
